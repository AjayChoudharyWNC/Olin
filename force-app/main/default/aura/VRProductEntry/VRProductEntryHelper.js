            ...
            if (state === "SUCCESS") {
                ...
                if(result.length > 0){
                    ...
                    for ( var i = 0; i < result.length; i++ ) {
                        ...
                        /*if(result[i].FCM_Product__r.LegacyOCAPCode_R1__c != null){
                            result[i].Code = result[i].FCM_Product__r.LegacyOCAPCode_R1__c;
                        }
                        if(result[i].FCM_Product__r.LegacyBCCode_R1__c != null){
                            result[i].Code = result[i].FCM_Product__r.LegacyBCCode_R1__c;
                        }*/
        ...
        action.setCallback(this, function(response){
            ...
            if (state === "SUCCESS") {
                ...
                if(result.length > 0){
                    ...
                    for ( var i = 0; i < result.length; i++ ) {
                        /*if(result[i].LegacyOCAPCode_R1__c != undefined){
                            result[i].Code = result[i].LegacyOCAPCode_R1__c;
                        }
                        if(result[i].LegacyBCCode_R1__c != undefined){
                            result[i].Code = result[i].LegacyBCCode_R1__c;
                        }*/
